# Contributing to ULRATTACK

Thank you for your interest in contributing to ULRATTACK! This guide will help you get started with development and contributions.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/useulrattack/ulrattack.git
   cd ulrattack
   ```
...
3. **Configure your LLM provider**
   ```bash
   export ULRATTACK_LLM="openai/gpt-5"
   export LLM_API_KEY="your-api-key"
   ```

4. **Run ULRATTACK in development mode**
   ```bash
   poetry run ulrattack --target https://example.com
   ```

## 📚 Contributing Skills

Skills are specialized knowledge packages that enhance agent capabilities. See [ulrattack/skills/README.md](ulrattack/skills/README.md) for detailed guidelines.
...
- **Issues**: [GitHub Issues](https://github.com/useulrattack/ulrattack/issues)
