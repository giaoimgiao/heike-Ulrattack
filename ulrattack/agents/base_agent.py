...
if TYPE_CHECKING:
    from ulrattack.telemetry.tracer import Tracer
...
from ulrattack.llm import LLM, LLMConfig, LLMRequestFailedError
from ulrattack.llm.utils import clean_content
from ulrattack.runtime import SandboxInitializationError
from ulrattack.tools import process_tool_invocations
from ulrattack.utils.resource_paths import get_ulrattack_resource_path
...
class AgentMeta(type):
    ...
    def __new__(cls, name: str, bases: tuple[type, ...], attrs: dict[str, Any]) -> type:
        ...
        prompt_dir = get_ulrattack_resource_path("agents", name)
...
class BaseAgent(metaclass=AgentMeta):
    ...
    def _add_to_agents_graph(self) -> None:
        from ulrattack.tools.agents_graph import agents_graph_actions
    ...
    async def _initialize_sandbox_and_state(self, task: str) -> None:
        ...
        sandbox_mode = os.getenv("ULRATTACK_SANDBOX_MODE", "false").lower() == "true"
        if not sandbox_mode and self.state.sandbox_id is None:
            from ulrattack.runtime import get_runtime
            ...
            try:
                ...
                from ulrattack.telemetry import posthog
    ...
    def _check_agent_messages(self, state: AgentState) -> None:  # noqa: PLR0912
        try:
            from ulrattack.tools.agents_graph.agents_graph_actions import _agent_graph, _agent_messages
