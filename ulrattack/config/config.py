...
class Config:
    """Configuration Manager for ULRATTACK."""
    ...
    ulrattack_reasoning_effort = "high"
    ulrattack_llm_max_retries = "5"
    ulrattack_memory_compressor_timeout = "30"
    llm_timeout = "300"
    _LLM_CANONICAL_NAMES = (
        ...
        "litellm_base_url",
        "ollama_api_base",
        "ulrattack_reasoning_effort",
        "ulrattack_llm_max_retries",
        "ulrattack_memory_compressor_timeout",
        "llm_timeout",
    )

    # Tool & Feature Configuration
    perplexity_api_key = None
    ulrattack_disable_browser = "false"

    # Runtime Configuration
    ulrattack_image = "ghcr.io/usestrix/strix-sandbox:0.1.10"
    ulrattack_runtime_backend = "docker"
    ulrattack_sandbox_execution_timeout = "120"
    ulrattack_sandbox_connect_timeout = "10"

    # Telemetry
    ulrattack_telemetry = "1"
