...
if not SANDBOX_MODE:
    raise RuntimeError("Tool server should only run in sandbox mode (ULRATTACK_SANDBOX_MODE=true)")

parser = argparse.ArgumentParser(description="Start ULRATTACK tool server")
