...
if os.getenv("ULRATTACK_SANDBOX_MODE", "false").lower() == "false":
...
SANDBOX_EXECUTION_TIMEOUT = float(Config.get("ulrattack_sandbox_execution_timeout") or "120")
SANDBOX_CONNECT_TIMEOUT = float(Config.get("ulrattack_sandbox_connect_timeout") or "10")
